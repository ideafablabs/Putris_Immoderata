...
// Putris
  ws2812fx.setSegment(3, 1, 32, FX_MODE_STATIC, BLACK, 5000, REVERSE); 
  ws2812fx.setIdleSegment(4, 1, 31, FX_MODE_STATIC, COLORS(RED, ORANGE, YELLOW), 1200, NO_OPTIONS);
// Vivus
  ws2812fx.setSegment(5, 1, 32, FX_MODE_STATIC, BLACK, 5000, REVERSE); 
  ws2812fx.setIdleSegment(6, 1, 31, FX_MODE_STATIC, COLORS(DIM(GREEN), BLUE), 1000, NO_OPTIONS);
  ws2812fx.start();
}
